...
class EditResultForm(forms.Form):
    ...
    try:
        ...
        for s in students:
            print(s)
            s_single=(s.id,str(s.admin))
            students_list.append(s_single)
    except:
        students_list=[]
    ...
    student_ids=ChoiceNoValidation(label="Student",choices=students_list ,widget=forms.Select(attrs={"class":"form-control"}))
